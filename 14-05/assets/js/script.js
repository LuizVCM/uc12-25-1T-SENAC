const boxes = document.querySelectorAll(".in");
...
Eles são enviados pelo prórpio navegador quando o observador detecta mudanças.
...
observer é o prórpio observador criado pelo: const observer = new IntersectionObserve(...)
